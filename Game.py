...
class Game:
    def __init__(self, args, training=True):
        ...
        self.pi_teacher_noise = args.pi_teacher_noise
        self.pi_teacher_noise_ratio = args.pi_teacher_noise_ratio
    ...
    def collect(self):
        ...
        with torch.no_grad():
            ...
            while not done and ep_len < self.max_ep_len:
                ...
                if self.student_policy.teacher_value_loss_coef > self.student_policy.eplison:
