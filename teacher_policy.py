...
class TeacherPolicy():
    def __init__(self, task, offline, soft, prefix, action_space, agent_view_size, LLM_noise = "False", LLM_noise_ratio = 0.2, pi_teacher_noise = "gaussian", noise_ratio = 0.2):
        self.planner = Planner(task, offline, soft, prefix, LLM_noise = LLM_noise, LLM_noise_ratio = LLM_noise_ratio, pi_teacher_noise = pi_teacher_noise, noise_ratio = noise_ratio)
