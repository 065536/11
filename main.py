...
if __name__ == "__main__":
    ...
    parser.add_argument("--LLM_noise_ratio", type=float, default=0.2)
    parser.add_argument("--pi_teacher_noise", type=str, default="False")
    parser.add_argument("--pi_teacher_noise_ratio", type=float, default=0.2)
